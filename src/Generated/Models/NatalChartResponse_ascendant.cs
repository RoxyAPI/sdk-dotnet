...
namespace RoxyApi.Models
{
    ...
    public partial class NatalChartResponse_ascendant : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Degree within the Ascendant sign (0-29.999).</summary>
        public double? Degree { get; set; }
        /// <summary>Absolute ecliptic longitude of the Ascendant (0-360).</summary>
        public double? Longitude { get; set; }
        /// <summary>Zodiac sign on the Ascendant (rising sign). Always English, whatever the lang parameter says. Use signLocalized for anything a reader sees.</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Models.NatalChartResponse_ascendant"/> and sets the default values.
        /// </summary>
        public NatalChartResponse_ascendant()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Models.NatalChartResponse_ascendant"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.Models.NatalChartResponse_ascendant CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.Models.NatalChartResponse_ascendant();
        }
        /// <summary>
