...
namespace RoxyApi.Models
{
    ...
    public partial class KalsarpaRequest : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::RoxyApi.Models.KalsarpaRequest_ayanamsa? Ayanamsa { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Models.KalsarpaRequest"/> and sets the default values.
        /// </summary>
        public KalsarpaRequest()
        {
            AdditionalData = new Dictionary<string, object>();
            Ayanamsa = global::RoxyApi.Models.KalsarpaRequest_ayanamsa.Lahiri;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Models.KalsarpaRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.Models.KalsarpaRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.Models.KalsarpaRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "ayanamsa", n => { Ayanamsa = n.GetEnumValue<global::RoxyApi.Models.KalsarpaRequest_ayanamsa>(); } },
                { "ayanamsaValue", n => { AyanamsaValue = n.GetDoubleValue(); } },
                { "date", n => { Date = n.GetDateValue(); } },
                { "latitude", n => { Latitude = n.GetDoubleValue(); } },
                { "longitude", n => { Longitude = n.GetDoubleValue(); } },
                { "time", n => { Time = n.GetTimeValue(); } },
                { "timezone", n => { Timezone = n.GetObjectValue<global::RoxyApi.Models.KalsarpaRequest.KalsarpaRequest_timezone>(global::RoxyApi.Models.KalsarpaRequest.KalsarpaRequest_timezone.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::RoxyApi.Models.KalsarpaRequest_ayanamsa>("ayanamsa", Ayanamsa);
            writer.WriteDoubleValue("ayanamsaValue", AyanamsaValue);
            writer.WriteDateValue("date", Date);
            writer.WriteDoubleValue("latitude", Latitude);
            writer.WriteDoubleValue("longitude", Longitude);
            writer.WriteTimeValue("time", Time);
            writer.WriteObjectValue<global::RoxyApi.Models.KalsarpaRequest.KalsarpaRequest_timezone>("timezone", Timezone);
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class KalsarpaRequest_timezone : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::RoxyApi.Models.KalsarpaRequest.KalsarpaRequest_timezone"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::RoxyApi.Models.KalsarpaRequest.KalsarpaRequest_timezone CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::RoxyApi.Models.KalsarpaRequest.KalsarpaRequest_timezone();
