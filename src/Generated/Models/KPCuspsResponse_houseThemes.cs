...
namespace RoxyApi.Models
{
    ...
    public partial class KPCuspsResponse_houseThemes : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Models.KPCuspsResponse_houseThemes"/> and sets the default values.
        /// </summary>
        public KPCuspsResponse_houseThemes()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Models.KPCuspsResponse_houseThemes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.Models.KPCuspsResponse_houseThemes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.Models.KPCuspsResponse_houseThemes();
        }
        /// <summary>
