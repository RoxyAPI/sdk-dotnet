...
namespace RoxyApi.Models
{
    ...
    public partial class RelocationPlanet : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// <summary>Relocated placement interpretation. The planet keeps its natal sign, so this reads its meaning through the new house it occupies at this location.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::RoxyApi.Models.RelocationPlanet_interpretation? Interpretation { get; set; }
#nullable restore
#else
        public global::RoxyApi.Models.RelocationPlanet_interpretation Interpretation { get; set; }
#endif
        ...
        public global::RoxyApi.Models.RelocationPlanet_name? Name { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Models.RelocationPlanet"/> and sets the default values.
        /// </summary>
        public RelocationPlanet()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Models.RelocationPlanet"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.Models.RelocationPlanet CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.Models.RelocationPlanet();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "interpretation", n => { Interpretation = n.GetObjectValue<global::RoxyApi.Models.RelocationPlanet_interpretation>(global::RoxyApi.Models.RelocationPlanet_interpretation.CreateFromDiscriminatorValue); } },
                { "isRetrograde", n => { IsRetrograde = n.GetBoolValue(); } },
                { "latitude", n => { Latitude = n.GetDoubleValue(); } },
                { "longitude", n => { Longitude = n.GetDoubleValue(); } },
                { "name", n => { Name = n.GetEnumValue<global::RoxyApi.Models.RelocationPlanet_name>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::RoxyApi.Models.RelocationPlanet_interpretation>("interpretation", Interpretation);
            writer.WriteBoolValue("isRetrograde", IsRetrograde);
            writer.WriteDoubleValue("latitude", Latitude);
            writer.WriteDoubleValue("longitude", Longitude);
            writer.WriteEnumValue<global::RoxyApi.Models.RelocationPlanet_name>("name", Name);
