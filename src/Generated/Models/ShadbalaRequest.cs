...
namespace RoxyApi.Models
{
    ...
    public partial class ShadbalaRequest : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::RoxyApi.Models.ShadbalaRequest_ayanamsa? Ayanamsa { get; set; }
...
#nullable enable
        public global::RoxyApi.Models.ShadbalaRequest.ShadbalaRequest_timezone? Timezone { get; set; }
#nullable restore
#else
        public global::RoxyApi.Models.ShadbalaRequest.ShadbalaRequest_timezone Timezone { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Models.ShadbalaRequest"/> and sets the default values.
        /// </summary>
        public ShadbalaRequest()
        {
            AdditionalData = new Dictionary<string, object>();
            Ayanamsa = global::RoxyApi.Models.ShadbalaRequest_ayanamsa.Lahiri;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Models.ShadbalaRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.Models.ShadbalaRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.Models.ShadbalaRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "ayanamsa", n => { Ayanamsa = n.GetEnumValue<global::RoxyApi.Models.ShadbalaRequest_ayanamsa>(); } },
                { "ayanamsaValue", n => { AyanamsaValue = n.GetDoubleValue(); } },
                { "date", n => { Date = n.GetDateValue(); } },
                { "latitude", n => { Latitude = n.GetDoubleValue(); } },
                { "longitude", n => { Longitude = n.GetDoubleValue(); } },
                { "time", n => { Time = n.GetTimeValue(); } },
                { "timezone", n => { Timezone = n.GetObjectValue<global::RoxyApi.Models.ShadbalaRequest.ShadbalaRequest_timezone>(global::RoxyApi.Models.ShadbalaRequest.ShadbalaRequest_timezone.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::RoxyApi.Models.ShadbalaRequest_ayanamsa>("ayanamsa", Ayanamsa);
            writer.WriteDoubleValue("ayanamsaValue", AyanamsaValue);
            writer.WriteDateValue("date", Date);
            writer.WriteDoubleValue("latitude", Latitude);
            writer.WriteDoubleValue("longitude", Longitude);
            writer.WriteTimeValue("time", Time);
            writer.WriteObjectValue<global::RoxyApi.Models.ShadbalaRequest.ShadbalaRequest_timezone>("timezone", Timezone);
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ShadbalaRequest_timezone : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::RoxyApi.Models.ShadbalaRequest.ShadbalaRequest_timezone"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::RoxyApi.Models.ShadbalaRequest.ShadbalaRequest_timezone CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::RoxyApi.Models.ShadbalaRequest.ShadbalaRequest_timezone();
