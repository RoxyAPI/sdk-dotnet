...
namespace RoxyApi.Vastu.Mandala
{
    ...
    public partial class MandalaPostResponse_conventions : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Which division of the ground was projected. Echoes the resolved value whether it was sent or defaulted.</summary>
...
#nullable restore
        ...
        /// </summary>
        public MandalaPostResponse_conventions()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Vastu.Mandala.MandalaPostResponse_conventions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.Vastu.Mandala.MandalaPostResponse_conventions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.Vastu.Mandala.MandalaPostResponse_conventions();
        }
        /// <summary>
