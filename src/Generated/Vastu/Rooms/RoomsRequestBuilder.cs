...
{
    /// <summary>
    /// Builds and executes requests for operations under \vastu\rooms
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class RoomsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Vastu.Rooms.RoomsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RoomsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vastu/rooms{?lang*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Vastu.Rooms.RoomsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RoomsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vastu/rooms{?lang*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::RoxyApi.Vastu.Rooms.RoomsPostResponse?> PostAsync(global::RoxyApi.Vastu.Rooms.RoomsPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Vastu.Rooms.RoomsRequestBuilder.RoomsRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RoxyApi.Vastu.Rooms.RoomsPostResponse> PostAsync(global::RoxyApi.Vastu.Rooms.RoomsPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Vastu.Rooms.RoomsRequestBuilder.RoomsRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::RoxyApi.Vastu.Rooms.RoomsPostResponse>(requestInfo, global::RoxyApi.Vastu.Rooms.RoomsPostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Vastu room direction check for a whole floor plan: send the plot and a list of rooms, by quarter or by outline, and the API returns a verdict per room with the quarters it belongs in, the quarters to keep it out of, a remedy when it is misplaced, and a composite score with the weights published. Four of the twelve room types carry a chapter and verse and the other eight are labelled convention, so a report can say which half of it is classical. Built for floor plan tools, listing checks and practitioner reports.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Vastu.Rooms.RoomsPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Vastu.Rooms.RoomsRequestBuilder.RoomsRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Vastu.Rooms.RoomsPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Vastu.Rooms.RoomsRequestBuilder.RoomsRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Vastu.Rooms.RoomsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RoxyApi.Vastu.Rooms.RoomsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::RoxyApi.Vastu.Rooms.RoomsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Vastu room direction check for a whole floor plan: send the plot and a list of rooms, by quarter or by outline, and the API returns a verdict per room with the quarters it belongs in, the quarters to keep it out of, a remedy when it is misplaced, and a composite score with the weights published. Four of the twelve room types carry a chapter and verse and the other eight are labelled convention, so a report can say which half of it is classical. Built for floor plan tools, listing checks and practitioner reports.
        /// </summary>
        ...
        public partial class RoomsRequestBuilderPostQueryParameters 
        {
            ...
            [QueryParameter("lang")]
            public global::RoxyApi.Vastu.Rooms.PostLangQueryParameterType? Lang { get; set; }
        }
    }
}
