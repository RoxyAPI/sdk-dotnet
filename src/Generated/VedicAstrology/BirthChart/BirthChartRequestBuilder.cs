...
namespace RoxyApi.VedicAstrology.BirthChart
{
    ...
    public partial class BirthChartRequestBuilder : BaseRequestBuilder
    {
        ...
        public BirthChartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vedic-astrology/birth-chart{?lang*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.VedicAstrology.BirthChart.BirthChartRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BirthChartRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vedic-astrology/birth-chart{?lang*}", rawUrl)
        {
        }
        /// <summary>
