...
namespace RoxyApi.VedicAstrology.PlanetaryPositions.Monthly
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>Degrees traversed within the current sign (0-30). Useful for precise transit tracking.</summary>
        public double? DegreeInSign { get; set; }
        /// <summary>Whether the planet is in retrograde motion (vakri) on this date.</summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.VedicAstrology.PlanetaryPositions.Monthly.MonthlyPostResponse_days_positions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.VedicAstrology.PlanetaryPositions.Monthly.MonthlyPostResponse_days_positions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.VedicAstrology.PlanetaryPositions.Monthly.MonthlyPostResponse_days_positions();
        }
        /// <summary>
