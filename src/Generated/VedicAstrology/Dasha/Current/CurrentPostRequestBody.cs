...
namespace RoxyApi.VedicAstrology.Dasha.Current
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody_nodeType? NodeType { get; set; }
...
#nullable enable
        public global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody.CurrentPostRequestBody_timezone? Timezone { get; set; }
#nullable restore
#else
        public global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody.CurrentPostRequestBody_timezone Timezone { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody"/> and sets the default values.
        /// </summary>
        public CurrentPostRequestBody()
        {
            ...
            NodeType = global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody_nodeType.Mean;
            Significators = false;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "timezone", n => { Timezone = n.GetObjectValue<global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody.CurrentPostRequestBody_timezone>(global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody.CurrentPostRequestBody_timezone.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody.CurrentPostRequestBody_timezone>("timezone", Timezone);
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class CurrentPostRequestBody_timezone : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody.CurrentPostRequestBody_timezone"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody.CurrentPostRequestBody_timezone CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::RoxyApi.VedicAstrology.Dasha.Current.CurrentPostRequestBody.CurrentPostRequestBody_timezone();
