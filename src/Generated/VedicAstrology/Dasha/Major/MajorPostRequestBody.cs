...
namespace RoxyApi.VedicAstrology.Dasha.Major
{
    ...
    public partial class MajorPostRequestBody : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody_ayanamsa? Ayanamsa { get; set; }
        ...
        public global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody_nodeType? NodeType { get; set; }
...
#nullable enable
        public global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody.MajorPostRequestBody_timezone? Timezone { get; set; }
#nullable restore
#else
        public global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody.MajorPostRequestBody_timezone Timezone { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody"/> and sets the default values.
        /// </summary>
        public MajorPostRequestBody()
        {
            AdditionalData = new Dictionary<string, object>();
            Ayanamsa = global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody_ayanamsa.Lahiri;
            NodeType = global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody_nodeType.Mean;
            Significators = false;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "ayanamsa", n => { Ayanamsa = n.GetEnumValue<global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody_ayanamsa>(); } },
                { "ayanamsaValue", n => { AyanamsaValue = n.GetDoubleValue(); } },
                { "date", n => { Date = n.GetDateValue(); } },
                { "latitude", n => { Latitude = n.GetDoubleValue(); } },
                { "longitude", n => { Longitude = n.GetDoubleValue(); } },
                { "nodeType", n => { NodeType = n.GetEnumValue<global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody_nodeType>(); } },
                { "significators", n => { Significators = n.GetBoolValue(); } },
                { "time", n => { Time = n.GetTimeValue(); } },
                { "timezone", n => { Timezone = n.GetObjectValue<global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody.MajorPostRequestBody_timezone>(global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody.MajorPostRequestBody_timezone.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody_ayanamsa>("ayanamsa", Ayanamsa);
            writer.WriteDoubleValue("ayanamsaValue", AyanamsaValue);
            writer.WriteDateValue("date", Date);
            writer.WriteDoubleValue("latitude", Latitude);
            writer.WriteDoubleValue("longitude", Longitude);
            writer.WriteEnumValue<global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody_nodeType>("nodeType", NodeType);
            writer.WriteBoolValue("significators", Significators);
            writer.WriteTimeValue("time", Time);
            writer.WriteObjectValue<global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody.MajorPostRequestBody_timezone>("timezone", Timezone);
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class MajorPostRequestBody_timezone : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody.MajorPostRequestBody_timezone"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody.MajorPostRequestBody_timezone CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::RoxyApi.VedicAstrology.Dasha.Major.MajorPostRequestBody.MajorPostRequestBody_timezone();
