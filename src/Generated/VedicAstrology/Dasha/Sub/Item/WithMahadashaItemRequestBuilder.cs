...
namespace RoxyApi.VedicAstrology.Dasha.Sub.Item
{
    ...
    public partial class WithMahadashaItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithMahadashaItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vedic-astrology/dasha/sub/{mahadasha}{?focus*,lang*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.VedicAstrology.Dasha.Sub.Item.WithMahadashaItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithMahadashaItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vedic-astrology/dasha/sub/{mahadasha}{?focus*,lang*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        public partial class WithMahadashaItemRequestBuilderPostQueryParameters 
        {
            ...
            public global::RoxyApi.VedicAstrology.Dasha.Sub.Item.PostFocusQueryParameterType? Focus { get; set; }
