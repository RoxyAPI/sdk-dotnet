...
namespace RoxyApi.VedicAstrology.Dasha.Sub.Item.Item
{
    ...
    public partial class WithAntardashaPostRequestBody : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody_nodeType? NodeType { get; set; }
...
#nullable enable
        public global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody.WithAntardashaPostRequestBody_timezone? Timezone { get; set; }
#nullable restore
#else
        public global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody.WithAntardashaPostRequestBody_timezone Timezone { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody"/> and sets the default values.
        /// </summary>
        public WithAntardashaPostRequestBody()
        {
            AdditionalData = new Dictionary<string, object>();
            Ayanamsa = global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody_ayanamsa.Lahiri;
            NodeType = global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody_nodeType.Mean;
            Significators = false;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "nodeType", n => { NodeType = n.GetEnumValue<global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody_nodeType>(); } },
                { "significators", n => { Significators = n.GetBoolValue(); } },
                { "time", n => { Time = n.GetTimeValue(); } },
                { "timezone", n => { Timezone = n.GetObjectValue<global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody.WithAntardashaPostRequestBody_timezone>(global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody.WithAntardashaPostRequestBody_timezone.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody_nodeType>("nodeType", NodeType);
            writer.WriteBoolValue("significators", Significators);
            writer.WriteTimeValue("time", Time);
            writer.WriteObjectValue<global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody.WithAntardashaPostRequestBody_timezone>("timezone", Timezone);
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithAntardashaPostRequestBody_timezone : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody.WithAntardashaPostRequestBody_timezone"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody.WithAntardashaPostRequestBody_timezone CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaPostRequestBody.WithAntardashaPostRequestBody_timezone();
