...
namespace RoxyApi.VedicAstrology.Dasha.Sub.Item.Item
{
    ...
    public partial class WithAntardashaItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithAntardashaItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vedic-astrology/dasha/sub/{mahadasha}/{antardasha}{?focus*,lang*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.WithAntardashaItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithAntardashaItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vedic-astrology/dasha/sub/{mahadasha}/{antardasha}{?focus*,lang*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        public partial class WithAntardashaItemRequestBuilderPostQueryParameters 
        {
            ...
            public global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.PostFocusQueryParameterType? Focus { get; set; }
