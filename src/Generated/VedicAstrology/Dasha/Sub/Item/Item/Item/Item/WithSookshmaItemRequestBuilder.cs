...
namespace RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.Item.Item
{
    ...
    public partial class WithSookshmaItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithSookshmaItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vedic-astrology/dasha/sub/{mahadasha}/{antardasha}/{pratyantardasha}/{sookshma}{?lang*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.VedicAstrology.Dasha.Sub.Item.Item.Item.Item.WithSookshmaItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithSookshmaItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vedic-astrology/dasha/sub/{mahadasha}/{antardasha}/{pratyantardasha}/{sookshma}{?lang*}", rawUrl)
        {
        }
        /// <summary>
