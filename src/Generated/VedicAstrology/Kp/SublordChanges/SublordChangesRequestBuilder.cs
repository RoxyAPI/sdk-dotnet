...
using System;
namespace RoxyApi.VedicAstrology.Kp.SublordChanges
{
    /// <summary>
    /// Builds and executes requests for operations under \vedic-astrology\kp\sublord-changes
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class SublordChangesRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.VedicAstrology.Kp.SublordChanges.SublordChangesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SublordChangesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vedic-astrology/kp/sublord-changes", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.VedicAstrology.Kp.SublordChanges.SublordChangesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SublordChangesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vedic-astrology/kp/sublord-changes", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::RoxyApi.Models.KPSublordChangesResponse?> PostAsync(global::RoxyApi.Models.KPSublordChangesRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RoxyApi.Models.KPSublordChangesResponse> PostAsync(global::RoxyApi.Models.KPSublordChangesRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Models.KPSublordChangesRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Models.KPSublordChangesRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.VedicAstrology.Kp.SublordChanges.SublordChangesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RoxyApi.VedicAstrology.Kp.SublordChanges.SublordChangesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::RoxyApi.VedicAstrology.Kp.SublordChanges.SublordChangesRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
