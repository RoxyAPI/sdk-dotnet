...
namespace RoxyApi.AngelNumbers.Numbers.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.AngelNumbers.Numbers.Item.WithNumberItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithNumberItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/angel-numbers/numbers/{number}{?lang*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.AngelNumbers.Numbers.Item.WithNumberItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithNumberItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/angel-numbers/numbers/{number}{?lang*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::RoxyApi.AngelNumbers.Numbers.Item.WithNumberGetResponse?> GetAsync(Action<RequestConfiguration<global::RoxyApi.AngelNumbers.Numbers.Item.WithNumberItemRequestBuilder.WithNumberItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RoxyApi.AngelNumbers.Numbers.Item.WithNumberGetResponse> GetAsync(Action<RequestConfiguration<global::RoxyApi.AngelNumbers.Numbers.Item.WithNumberItemRequestBuilder.WithNumberItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::RoxyApi.AngelNumbers.Numbers.Item.WithNumberItemRequestBuilder.WithNumberItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::RoxyApi.AngelNumbers.Numbers.Item.WithNumberItemRequestBuilder.WithNumberItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RoxyApi.AngelNumbers.Numbers.Item.WithNumberItemRequestBuilder WithUrl(string rawUrl)
        {
        ...
        public partial class WithNumberItemRequestBuilderGetQueryParameters 
        {
            ...
            [QueryParameter("lang")]
            public global::RoxyApi.AngelNumbers.Numbers.Item.GetLangQueryParameterType? Lang { get; set; }
        }
    }
}
