...
namespace RoxyApi.HumanDesign.Connection
{
    ...
    public partial class ConnectionPostResponse_channels : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The two centers this channel connects in the bodygraph.</summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<double?>? PersonAGates { get; set; }
#nullable restore
#else
        public List<double?> PersonAGates { get; set; }
#endif
        /// <summary>Which of the channel two gates person B holds, from one to both.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<double?>? PersonBGates { get; set; }
#nullable restore
#else
        public List<double?> PersonBGates { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.HumanDesign.Connection.ConnectionPostResponse_channels"/> and sets the default values.
        /// </summary>
        public ConnectionPostResponse_channels()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.HumanDesign.Connection.ConnectionPostResponse_channels"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.HumanDesign.Connection.ConnectionPostResponse_channels CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.HumanDesign.Connection.ConnectionPostResponse_channels();
        }
        /// <summary>
