...
namespace RoxyApi.HumanDesign.Transit
{
    ...
    public partial class TransitPostResponse_completedChannels : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The two centers this channel connects and temporarily defines.</summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<double?>? NatalGates { get; set; }
#nullable restore
#else
        public List<double?> NatalGates { get; set; }
#endif
        /// <summary>Gate or gates of this channel supplied by the transit. One gate for a personal channel, both gates for an educational channel.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<double?>? TransitGates { get; set; }
#nullable restore
#else
        public List<double?> TransitGates { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.HumanDesign.Transit.TransitPostResponse_completedChannels"/> and sets the default values.
        /// </summary>
        public TransitPostResponse_completedChannels()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.HumanDesign.Transit.TransitPostResponse_completedChannels"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.HumanDesign.Transit.TransitPostResponse_completedChannels CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.HumanDesign.Transit.TransitPostResponse_completedChannels();
        }
        /// <summary>
