...
namespace RoxyApi.Usage
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Usage.UsageRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::RoxyApi.Usage.UsageGetResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RoxyApi.Usage.UsageGetResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Usage.UsageRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RoxyApi.Usage.UsageRequestBuilder WithUrl(string rawUrl)
        {
            return new global::RoxyApi.Usage.UsageRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
