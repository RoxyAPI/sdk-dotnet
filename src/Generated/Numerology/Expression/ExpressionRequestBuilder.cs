...
{
    /// <summary>
    /// Builds and executes requests for operations under \numerology\expression
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class ExpressionRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Numerology.Expression.ExpressionRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExpressionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/numerology/expression{?lang*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Numerology.Expression.ExpressionRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExpressionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/numerology/expression{?lang*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::RoxyApi.Numerology.Expression.ExpressionPostResponse?> PostAsync(global::RoxyApi.Numerology.Expression.ExpressionPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Expression.ExpressionRequestBuilder.ExpressionRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RoxyApi.Numerology.Expression.ExpressionPostResponse> PostAsync(global::RoxyApi.Numerology.Expression.ExpressionPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Expression.ExpressionRequestBuilder.ExpressionRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Numerology.Expression.ExpressionPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Expression.ExpressionRequestBuilder.ExpressionRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Numerology.Expression.ExpressionPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Expression.ExpressionRequestBuilder.ExpressionRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Numerology.Expression.ExpressionRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RoxyApi.Numerology.Expression.ExpressionRequestBuilder WithUrl(string rawUrl)
        {
        ...
        public partial class ExpressionRequestBuilderPostQueryParameters 
        {
            ...
            [QueryParameter("lang")]
            public global::RoxyApi.Numerology.Expression.PostLangQueryParameterType? Lang { get; set; }
        }
    }
}
