...
namespace RoxyApi.Numerology.Chart
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Numerology.Chart.ChartRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/numerology/chart{?lang*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Numerology.Chart.ChartRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChartRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/numerology/chart{?lang*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::RoxyApi.Numerology.Chart.ChartPostResponse?> PostAsync(global::RoxyApi.Numerology.Chart.ChartPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Chart.ChartRequestBuilder.ChartRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RoxyApi.Numerology.Chart.ChartPostResponse> PostAsync(global::RoxyApi.Numerology.Chart.ChartPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Chart.ChartRequestBuilder.ChartRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::RoxyApi.Numerology.Chart.ChartPostResponse>(requestInfo, global::RoxyApi.Numerology.Chart.ChartPostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Generate a comprehensive numerology chart combining all major calculations: Life Path, Expression, Soul Urge, Personality, Birth Day, Maturity, Karmic Lessons, Karmic Debt, and Personal Year. This single endpoint provides everything needed for a full numerology reading. Returns detailed interpretations for all numbers, karmic analysis, yearly forecast, and holistic summary. Perfect for numerology apps, complete reading services, birth chart generators, and comprehensive analysis tools. Save multiple API calls by getting the full chart in one request. Ideal for generating PDF reports or detailed user profiles.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Numerology.Chart.ChartPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Chart.ChartRequestBuilder.ChartRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Numerology.Chart.ChartPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Chart.ChartRequestBuilder.ChartRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Numerology.Chart.ChartRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RoxyApi.Numerology.Chart.ChartRequestBuilder WithUrl(string rawUrl)
        {
            return new global::RoxyApi.Numerology.Chart.ChartRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Generate a comprehensive numerology chart combining all major calculations: Life Path, Expression, Soul Urge, Personality, Birth Day, Maturity, Karmic Lessons, Karmic Debt, and Personal Year. This single endpoint provides everything needed for a full numerology reading. Returns detailed interpretations for all numbers, karmic analysis, yearly forecast, and holistic summary. Perfect for numerology apps, complete reading services, birth chart generators, and comprehensive analysis tools. Save multiple API calls by getting the full chart in one request. Ideal for generating PDF reports or detailed user profiles.
        /// </summary>
        ...
        public partial class ChartRequestBuilderPostQueryParameters 
        {
            ...
            [QueryParameter("lang")]
            public global::RoxyApi.Numerology.Chart.PostLangQueryParameterType? Lang { get; set; }
        }
    }
}
