...
namespace RoxyApi.Numerology.Daily
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Numerology.Daily.DailyRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DailyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/numerology/daily{?lang*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Numerology.Daily.DailyRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DailyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/numerology/daily{?lang*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::RoxyApi.Numerology.Daily.DailyPostResponse?> PostAsync(global::RoxyApi.Numerology.Daily.DailyPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Daily.DailyRequestBuilder.DailyRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RoxyApi.Numerology.Daily.DailyPostResponse> PostAsync(global::RoxyApi.Numerology.Daily.DailyPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Daily.DailyRequestBuilder.DailyRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Numerology.Daily.DailyPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Daily.DailyRequestBuilder.DailyRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Numerology.Daily.DailyPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Daily.DailyRequestBuilder.DailyRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Numerology.Daily.DailyRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RoxyApi.Numerology.Daily.DailyRequestBuilder WithUrl(string rawUrl)
        {
        ...
        public partial class DailyRequestBuilderPostQueryParameters 
        {
            ...
            [QueryParameter("lang")]
            public global::RoxyApi.Numerology.Daily.PostLangQueryParameterType? Lang { get; set; }
        }
    }
}
