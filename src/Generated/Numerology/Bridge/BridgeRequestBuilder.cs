...
namespace RoxyApi.Numerology.Bridge
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Numerology.Bridge.BridgeRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BridgeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/numerology/bridge{?lang*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Numerology.Bridge.BridgeRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BridgeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/numerology/bridge{?lang*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::RoxyApi.Numerology.Bridge.BridgePostResponse?> PostAsync(global::RoxyApi.Numerology.Bridge.BridgePostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Bridge.BridgeRequestBuilder.BridgeRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RoxyApi.Numerology.Bridge.BridgePostResponse> PostAsync(global::RoxyApi.Numerology.Bridge.BridgePostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Bridge.BridgeRequestBuilder.BridgeRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Numerology.Bridge.BridgePostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Bridge.BridgeRequestBuilder.BridgeRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Numerology.Bridge.BridgePostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Numerology.Bridge.BridgeRequestBuilder.BridgeRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Numerology.Bridge.BridgeRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RoxyApi.Numerology.Bridge.BridgeRequestBuilder WithUrl(string rawUrl)
        {
        ...
        public partial class BridgeRequestBuilderPostQueryParameters 
        {
            ...
            [QueryParameter("lang")]
            public global::RoxyApi.Numerology.Bridge.PostLangQueryParameterType? Lang { get; set; }
        }
    }
}
