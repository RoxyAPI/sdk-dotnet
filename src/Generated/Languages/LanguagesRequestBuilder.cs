...
using RoxyApi.Languages.FieldLabels;
...
namespace RoxyApi.Languages
{
    ...
    {
        /// <summary>The fieldLabels property</summary>
        public global::RoxyApi.Languages.FieldLabels.FieldLabelsRequestBuilder FieldLabels
        {
            get => new global::RoxyApi.Languages.FieldLabels.FieldLabelsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Languages.LanguagesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::RoxyApi.Languages.LanguagesGetResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RoxyApi.Languages.LanguagesGetResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Languages.LanguagesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RoxyApi.Languages.LanguagesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::RoxyApi.Languages.LanguagesRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
