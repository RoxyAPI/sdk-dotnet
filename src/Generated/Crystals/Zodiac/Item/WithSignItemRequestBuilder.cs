...
{
    /// <summary>
    /// Builds and executes requests for operations under \crystals\zodiac\{sign}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithSignItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Crystals.Zodiac.Item.WithSignItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithSignItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/crystals/zodiac/{sign}{?lang*,limit*,offset*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Crystals.Zodiac.Item.WithSignItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithSignItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/crystals/zodiac/{sign}{?lang*,limit*,offset*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::RoxyApi.Crystals.Zodiac.Item.WithSignGetResponse?> GetAsync(Action<RequestConfiguration<global::RoxyApi.Crystals.Zodiac.Item.WithSignItemRequestBuilder.WithSignItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RoxyApi.Crystals.Zodiac.Item.WithSignGetResponse> GetAsync(Action<RequestConfiguration<global::RoxyApi.Crystals.Zodiac.Item.WithSignItemRequestBuilder.WithSignItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::RoxyApi.Crystals.Zodiac.Item.WithSignItemRequestBuilder.WithSignItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::RoxyApi.Crystals.Zodiac.Item.WithSignItemRequestBuilder.WithSignItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RoxyApi.Crystals.Zodiac.Item.WithSignItemRequestBuilder WithUrl(string rawUrl)
        {
