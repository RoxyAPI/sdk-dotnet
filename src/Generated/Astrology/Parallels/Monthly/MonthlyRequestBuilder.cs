...
{
    /// <summary>
    /// Builds and executes requests for operations under \astrology\parallels\monthly
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class MonthlyRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Astrology.Parallels.Monthly.MonthlyRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MonthlyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/astrology/parallels/monthly{?lang*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RoxyApi.Astrology.Parallels.Monthly.MonthlyRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MonthlyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/astrology/parallels/monthly{?lang*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostResponse"/></returns>
...
#nullable enable
        public async Task<global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostResponse?> PostAsync(global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Astrology.Parallels.Monthly.MonthlyRequestBuilder.MonthlyRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostResponse> PostAsync(global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Astrology.Parallels.Monthly.MonthlyRequestBuilder.MonthlyRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostResponse>(requestInfo, global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get every parallel and contraparallel of declination that perfects during a given month, across the 13 non-lunar Western bodies: the Sun and Mercury through Pluto, both lunar nodes, Chiron and Black Moon Lilith. A parallel is two bodies at the same declination and reads much like a conjunction; a contraparallel is equal and opposite declinations and reads much like an opposition. Neither depends on zodiacal distance, so they surface connections an aspect table cannot show, which is why traditional and modern practitioners read them alongside aspects. Declinations are geocentric, matching what an ephemeris publishes. Returns the exact date and time of closest approach in your timezone with both declinations. The Moon is excluded because its declination swings the full range every month and would bury the slow pairs. Omit year and month to get the month in progress, so a published calendar stays current without a redeploy. Essential for declination work, out-of-bounds tracking, monthly forecast copy, and electional timing. Monthly parallel calendar API, declination aspects, contraparallel ephemeris. Verified against NASA JPL Horizons.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Astrology.Parallels.Monthly.MonthlyRequestBuilder.MonthlyRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody body, Action<RequestConfiguration<global::RoxyApi.Astrology.Parallels.Monthly.MonthlyRequestBuilder.MonthlyRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Astrology.Parallels.Monthly.MonthlyRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RoxyApi.Astrology.Parallels.Monthly.MonthlyRequestBuilder WithUrl(string rawUrl)
        {
            return new global::RoxyApi.Astrology.Parallels.Monthly.MonthlyRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get every parallel and contraparallel of declination that perfects during a given month, across the 13 non-lunar Western bodies: the Sun and Mercury through Pluto, both lunar nodes, Chiron and Black Moon Lilith. A parallel is two bodies at the same declination and reads much like a conjunction; a contraparallel is equal and opposite declinations and reads much like an opposition. Neither depends on zodiacal distance, so they surface connections an aspect table cannot show, which is why traditional and modern practitioners read them alongside aspects. Declinations are geocentric, matching what an ephemeris publishes. Returns the exact date and time of closest approach in your timezone with both declinations. The Moon is excluded because its declination swings the full range every month and would bury the slow pairs. Omit year and month to get the month in progress, so a published calendar stays current without a redeploy. Essential for declination work, out-of-bounds tracking, monthly forecast copy, and electional timing. Monthly parallel calendar API, declination aspects, contraparallel ephemeris. Verified against NASA JPL Horizons.
        /// </summary>
        ...
        public partial class MonthlyRequestBuilderPostQueryParameters 
        {
            ...
            [QueryParameter("lang")]
            public global::RoxyApi.Astrology.Parallels.Monthly.PostLangQueryParameterType? Lang { get; set; }
        }
    }
}
