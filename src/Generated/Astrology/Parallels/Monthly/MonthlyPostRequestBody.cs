...
#nullable restore
        ...
        public MonthlyPostRequestBody()
        {
            ...
            NodeType = global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody_nodeType.True;
            Orb = 1.5;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "nodeType", n => { NodeType = n.GetEnumValue<global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody_nodeType>(); } },
                { "orb", n => { Orb = n.GetDoubleValue(); } },
                { "timezone", n => { Timezone = n.GetObjectValue<global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody.MonthlyPostRequestBody_timezone>(global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody.MonthlyPostRequestBody_timezone.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody_nodeType>("nodeType", NodeType);
            writer.WriteDoubleValue("orb", Orb);
            writer.WriteObjectValue<global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody.MonthlyPostRequestBody_timezone>("timezone", Timezone);
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody.MonthlyPostRequestBody_timezone"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody.MonthlyPostRequestBody_timezone CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::RoxyApi.Astrology.Parallels.Monthly.MonthlyPostRequestBody.MonthlyPostRequestBody_timezone();
