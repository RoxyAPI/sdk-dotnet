...
namespace RoxyApi.Astrology.Synastry
{
    ...
    public partial class SynastryPostResponse_person1 : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Ascendant position for person 1. Determines first house cusp and outward personality.</summary>
...
#nullable restore
        ...
        public string Name { get; set; }
#endif
        /// <summary>Planet positions for person 1, enough to render this side of a dual wheel without a second request. Per-planet interpretations are not repeated here; call the natal chart endpoint for an individual reading.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        public SynastryPostResponse_person1()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Astrology.Synastry.SynastryPostResponse_person1"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.Astrology.Synastry.SynastryPostResponse_person1 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.Astrology.Synastry.SynastryPostResponse_person1();
        }
        /// <summary>
