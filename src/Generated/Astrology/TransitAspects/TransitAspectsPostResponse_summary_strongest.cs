...
namespace RoxyApi.Astrology.TransitAspects
{
    ...
    public partial class TransitAspectsPostResponse_summary_strongest : IAdditionalDataHolder, IParsable
    {
        ...
        public global::RoxyApi.Astrology.TransitAspects.TransitAspectsPostResponse_summary_strongest_interpretation? Interpretation { get; set; }
        ...
        /// </summary>
        public TransitAspectsPostResponse_summary_strongest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::RoxyApi.Astrology.TransitAspects.TransitAspectsPostResponse_summary_strongest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::RoxyApi.Astrology.TransitAspects.TransitAspectsPostResponse_summary_strongest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::RoxyApi.Astrology.TransitAspects.TransitAspectsPostResponse_summary_strongest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "interpretation", n => { Interpretation = n.GetEnumValue<global::RoxyApi.Astrology.TransitAspects.TransitAspectsPostResponse_summary_strongest_interpretation>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::RoxyApi.Astrology.TransitAspects.TransitAspectsPostResponse_summary_strongest_interpretation>("interpretation", Interpretation);
